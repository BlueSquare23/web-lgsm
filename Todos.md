...
* [ ] Eliminate kill watchers.
  - This has always been a hack.
  - Instead just going to put a timeout on the watch thread. It'll die all on
    its own after an hour or something (don't know why I didn't think of this
    sooner).
  - Maybe even make the timeout configurable via the main.conf.
