...
- Logo image to new original mark
...
- Add new consistent layout and styling to all app's pages.

### Fixed

- Restructured forms classes. Broke things up, one form class per file.
